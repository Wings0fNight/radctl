...
import { chPasswd } from "../components/auth/ChangePassApi";
			...
			<div className="w-[40%] rounded-3xl bg-neutral-700 p-10 text-white shadow-2xl shadow-gray-900">
				...
				<form onSubmit={handleSubmit} className="flex flex-col gap-5">
					<div className="relative z-0 w-full mb-3 group">
						<input 
							className="p-4 block py-2.5 px-0 w-full text-smbg-transparent border-0 border-b-2 appearance-none text-white border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0  peer"
							type="password"
